...
| 集成类型 | 说明 | 详细文档 |
|---------|------|---------|
| **内置工具** | 文件操作、搜索、命令执行、网络请求、用户提问、工作流等基础能力 | [内置工具](./builtin-tools) |
...
4. **创建工作流** — 将触发器、代码、LLM、Agent 和人工确认节点编排成可运行流程，适合稳定重复的自动化。

几种方式的适用场景各不相同：高频内部 API 适合 MCP；标准化操作方法适合技能包；稳定可视化流程适合工作流；偶尔操控没有 API 的应用时使用 Computer Use。
